    ...
    <Page description="用于需要操作标签页的场景" title="标签页">
        <Card class="mb-5" title="打开/关闭标签页">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <Button type="primary" @click="closeTabByKey('/vben-admin/about')"> 关闭 "关于" 标签页 </Button>
            </div>
        </Card>
        ...
        <Card class="mb-5" title="动态标题">
            <div class="text-foreground/80 mb-3">该操作不会影响页面标题，仅修改Tab标题</div>
            <div class="flex flex-wrap items-center gap-3">
                <Input v-model:value="newTabTitle" class="w-40" placeholder="请输入新标题" />
