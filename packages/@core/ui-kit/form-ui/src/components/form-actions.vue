...
import { cn, formatDate, isFunction, triggerWindowResize } from '@vben-core/shared/utils';
...
<template>
    <div
        :class="
            cn('col-span-full w-full text-right', rootProps.compact ? 'pb-2' : 'pb-6', rootProps.actionWrapperClass)
        "
